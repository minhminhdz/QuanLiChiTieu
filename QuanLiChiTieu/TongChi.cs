...
{
    public partial class TongChi : Form
    {
        ...
        private void btnhienthi_Click(object sender, EventArgs e)
        {
            ...
            // Duyệt qua các dòng của dgvChitieu và thêm dữ liệu vào Series
            foreach (DataGridViewRow row in dgvChitieu.Rows)
            {
                if (row.Cells["Tgian"].Value != null && row.Cells["Tien"].Value != null)
                {
        ...
        private void TongChi_Load(object sender, EventArgs e)
        {
            load();
        }
        public void load()
